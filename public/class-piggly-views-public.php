 ...
 * @since      1.1.1                            Added wp_register_script
 * @package    PigglyViews
...
class PigglyViews_Public 
{
     ...
     * @since   1.1.1 Added the wp_register_script
     */
    public function enqueue_scripts() 
    {
        ...
        wp_register_script( $this->plugin_name.'_counter', plugin_dir_url( __FILE__ ) . 'js/piggly-views-cache.js', array(), $this->version, true );
        ...
        if ( ( ( defined( 'WP_CACHE' ) && WP_CACHE ) || defined('WPFC_MAIN_PATH') ) ) :
            ...
            if ( !wp_is_post_revision( $post ) && ( is_single() || is_page() ) ) :
                wp_enqueue_script( $this->plugin_name.'_counter', plugin_dir_url( __FILE__ ) . 'js/piggly-views-cache.js', array(), $this->version, true );
